...
export const metadata = {
  title: "도산공원 필러 잘하는 밀리클리닉 | MILLI CLINIC",
  description:
    ...
    <div className={styles.page}>
      ...
      <footer className={styles.footer}>
        <div className={`${styles.container} ${styles.footerInner}`}>
          <div>
            <p className={styles.footerBrand}>MILLI CLINIC 밀리클리닉</p>
            <p className={styles.footerAddr}>서울특별시 강남구 도산대로 (도산공원 인근) · 대표전화 02-000-0000</p>
          </div>
          <p className={styles.footerCopy}>&copy; 2026 MILLI CLINIC. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
